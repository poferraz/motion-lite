...
vi.mock('./lazyComponents', () => ({
  ...
  UploadPanel: ({ onSuccess, onCancel }: { onSuccess: (_csv: string, _rows: unknown[], _sessions: string[]) => void; onCancel: () => void }) => (
    <div data-testid="upload-panel">
      <button onClick={() => onSuccess('test csv', [], [])}>Upload Success</button>
      <button onClick={onCancel}>Cancel</button>
    </div>
  ),
  SessionSelect: ({ onContinue, onBack }: { onContinue: (_sessions: string[]) => void; onBack: () => void }) => (
